...
${nw_user_id3}                TestCase9_in_vrf
${nw_user_id4}                TestCase12_in_vrf

${name1}                      SA061100010
${name2}                      SA061100020
${name3}                      TestCase10_in_vlan
${name4}                      TestCase12_in_vlan

${prefix1}                    40.1.1.0/24
${prefix2}                    40.2.1.0/24
${prefix3}                    TestCase11_in_route
${prefix4}                    TestCase12_in_route
...
(4) Delete Route
    Delete Route  ${VRF_UUIDS['${nw_user_id4}']}  ${ROUTE_UUIDS['${prefix4}']}
...
(8) Delete Interface
    Delete Interface  ${VRF_UUIDS['${nw_user_id4}']}  ${INF_UUIDS['${name4}']}
...
(12) Delete Vrf
    Delete Vrf  ${VRF_UUIDS['${nw_user_id4}']}
