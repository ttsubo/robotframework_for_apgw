...
${test_num}                   TestCase11_in_route
${test_num_previous}          TestCase9_in_vrf

*** TestCases ***
(11-1) Create Route(40.2.1.0/24) in Vrf(V06010002)
...
(11-2) Check Status of Create_Route
...
(11-3) Check Connectivity From GateSW to Local_vm(40.2.1.1)
...
(11-4) Check Connectivity From remotePrefix to Local_vm(40.2.1.1)
    Sleep  30 seconds
