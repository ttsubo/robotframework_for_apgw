...
${test_num}                   TestCase10_in_vlan
${test_num_previous}          TestCase9_in_vrf

*** TestCases ***
(10-1) Create Interface(30.2.0.1/24) in VLAN(2002) in Vrf(V06010002)
...
(10-2) Check Status of Create_Interface
...
(10-3) Check Connectivity From GateSW to vFirewall(Primary)
...
(10-4) Check Connectivity From GateSW to vFirewall(Secondary)
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous}']}
    ...  ${ipv4_vfw2}
...
(10-5) Check Connectivity From GateSW to remotePrefix(192.168.204.1)
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous}']}
    ...  ${remotePrefix}
...
(10-6) Check Connectivity From remotePrefix to vFirewall
    Sleep  30 seconds
