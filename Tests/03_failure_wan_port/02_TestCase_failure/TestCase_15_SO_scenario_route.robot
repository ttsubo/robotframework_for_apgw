...
*** TestCases ***
(15-1) Create Route(40.2.1.0/24) in Vrf(V06010002)
...
(15-2) Check Status of Create_Route
...
(15-3) Check Connectivity From GateSW to Local_vm(40.2.1.1)
...
(15-4) Check Connectivity From remotePrefix to Local_vm(40.2.1.1)
    Sleep  30 seconds
