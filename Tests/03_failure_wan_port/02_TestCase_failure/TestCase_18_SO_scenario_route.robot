...
*** TestCases ***
(18-1) Create Route(40.1.1.0/24) in Vrf(V06010002)
...
(18-2) Check Status of Create_Route
...
(18-3) Check Connectivity From GateSW to Local_vm(40.1.1.1)
...
(18-4) Check Connectivity From remotePrefix to Local_vm(40.1.1.1)
    Sleep  30 seconds
