...
*** TestCases ***
(7-1) Create Interface(30.1.0.1/24) in VLAN(2001) in Vrf(V06010002)
...
(7-2) Check Status of Create_Interface
...
(7-5) Check Connectivity From GateSW to remotePrefix(192.168.204.1)
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous}']}
    ...  ${remotePrefix}
...
(7-6) Check Connectivity From remotePrefix to vFirewall
    Sleep  30 seconds
