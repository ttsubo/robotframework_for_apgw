...
*** TestCases ***
(6-1) Update Interface ServiceType
...
(6-2) Check Status of Update_Interface
...
(6-3) Check Connectivity From GateSW to vFirewall(Primary)
...
(6-4) Check Connectivity From GateSW to vFirewall(Secondary)
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous_vrf}']}
    ...  ${ipv4_vfw2}
...
(6-5) Check Connectivity From GateSW to remotePrefix
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous_vrf}']}
    ...  ${remotePrefix}
...
(6-6) Check Connectivity From GateSW to Local_vm(40.2.1.1)
    Wait Until Keyword Succeeds  60s  10s
    ...  Check Connectivity
    ...  ${VRF_UUIDS['${test_num_previous_vrf}']}
    ...  ${local_vm}
